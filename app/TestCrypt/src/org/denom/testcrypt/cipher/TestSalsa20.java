...
public class TestSalsa20
{
	byte[] zeroes = Bin( 64 ).getBytes();
	...
	{
		StreamCipher salsa = new Salsa20(rounds);
		...
		for (int i = 0; i != 7; i++)
		{
			...
			{
			case 0:
				MUST( Bin( buf ).equals( v0 ) );
				break;
			case 3:
				MUST( Bin( buf ).equals( v192 ) );
				break;
			case 4:
				MUST( Bin( buf ).equals( v256 ) );
				break;
			default:
				// ignore
			}
	...
	private void salsa20Test2(CipherParameters params, String v0, String v65472, String v65536)
	{
		...
		for (int i = 0; i != 1025; i++)
		{
			...
			case 0:
				...
				break;
			case 1023:
				MUST( Bin( buf ).equals( v65472 ) );
				break;
			case 1024:
				MUST( Bin( buf ).equals( v65536 ) );
				break;
			default:
				// ignore
			}
	...
	private void skipTest()
	{
		...
		CipherParameters params = new ParametersWithIV(new KeyParameter(HexDecode("0053A6F94C9FF24598EB3E91E4378ADD3083D6297CCF2275C81B6EC11467BA0D")), HexDecode("0D74DB42A91077DE"));
		Salsa20	engine = new Salsa20();
		...
		{
			THROW("skip forward 1000 failed");
		}
		...
		{
			THROW("skip position incorrect - " + 60 + " got " + engine.getPosition());
		}
		...
		for (int i = 0; i != 5000; i++)
		{
			...
			{
				THROW("skip forward at wrong position");
			}
			...
			{
				THROW("skip forward i failed: " + i);
			}

			if (engine.getPosition() != i + fragment.length)
			{
				THROW("cipher at wrong position: " + engine.getPosition() + " [" + i + "]");
			}
			...
			if (engine.getPosition() != i)
			{
				THROW("skip back at wrong position");
			}
	...
	TestSalsa20()
	{
		salsa20Test1(20, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				set1v0_0, set1v0_192,  set1v0_256,  set1v0_448);
		salsa20Test1(20, new ParametersWithIV(new KeyParameter(HexDecode("00400000000000000000000000000000")), HexDecode("0000000000000000")),
				set1v9_0, set1v9_192,  set1v9_256,  set1v9_448);
		salsa20Test1(12, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				salsa12_set1v0_0, salsa12_set1v0_192,  salsa12_set1v0_256,  salsa12_set1v0_448);
		salsa20Test1(8, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				salsa8_set1v0_0, salsa8_set1v0_192,  salsa8_set1v0_256,  salsa8_set1v0_448);
		salsa20Test2(new ParametersWithIV(new KeyParameter(HexDecode("0053A6F94C9FF24598EB3E91E4378ADD3083D6297CCF2275C81B6EC11467BA0D")), HexDecode("0D74DB42A91077DE")),
				set6v0_0, set6v0_65472, set6v0_65536);
		salsa20Test2(new ParametersWithIV(new KeyParameter(HexDecode("0558ABFE51A4F74A9DF04396E93C8FE23588DB2E81D4277ACD2073C6196CBF12")), HexDecode("167DE44BB21980E7")),
