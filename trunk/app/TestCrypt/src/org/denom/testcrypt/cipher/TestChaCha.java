...
public class TestChaCha
{
	...
	TestChaCha()
	{
		chachaTest1(20, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				set1v0_0, set1v0_192,  set1v0_256,  set1v0_448);
		chachaTest1(20, new ParametersWithIV(new KeyParameter(HexDecode("00400000000000000000000000000000")), HexDecode("0000000000000000")),
				set1v9_0, set1v9_192,  set1v9_256,  set1v9_448);
		chachaTest1(12, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				chacha12_set1v0_0, chacha12_set1v0_192,  chacha12_set1v0_256,  chacha12_set1v0_448);
		chachaTest1(8, new ParametersWithIV(new KeyParameter(HexDecode("80000000000000000000000000000000")), HexDecode("0000000000000000")),
				chacha8_set1v0_0, chacha8_set1v0_192,  chacha8_set1v0_256,  chacha8_set1v0_448);
		chachaTest2(new ParametersWithIV(new KeyParameter(HexDecode("0053A6F94C9FF24598EB3E91E4378ADD3083D6297CCF2275C81B6EC11467BA0D")), HexDecode("0D74DB42A91077DE")),
				set6v0_0, set6v0_65472, set6v0_65536);
		chachaTest2(new ParametersWithIV(new KeyParameter(HexDecode("0558ABFE51A4F74A9DF04396E93C8FE23588DB2E81D4277ACD2073C6196CBF12")), HexDecode("167DE44BB21980E7")),
	...
	{
		ChaCha chaCha = new ChaCha(rounds);
