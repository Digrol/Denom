...
public class Secp160r2 extends CustomFpCurve
{
	...
	public Secp160r2()
	{
		...
		super.init( new Element(), new Point( null, null, null ), "1.3.132.0.30",
			"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70", // a
			"B4E134D3FB59EB8BAB57274904664D5AF50388BA", // b
			"0100000000000000000000351EE786A818F3A1A16B", // order (n)
			"01", // cofactor (h)
			"04 52DCB034293A117E1F4FF11B30F7199D3144CE6D FEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E" ); // G point
	}
