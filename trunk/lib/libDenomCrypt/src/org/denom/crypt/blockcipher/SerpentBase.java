...
public abstract class SerpentBase implements BlockCipher
{
	...
	public void init( boolean encrypting, CipherParameters params )
	{
		...
		THROW( "invalid parameter passed to " + getAlgorithmName() + " init - " + params.getClass().getName() );
	}
	...
	/**
	 * The sboxes below are based on the work of Brian Gladman and Sam Simpson, whose original
