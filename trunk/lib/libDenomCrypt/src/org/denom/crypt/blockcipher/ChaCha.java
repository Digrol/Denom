...
public class ChaCha extends Salsa20
{
	...
	protected void setKey( byte[] keyBytes, byte[] ivBytes )
	{
		if( keyBytes != null )
		{
			...
			// Key
			Static.littleEndianToInt( keyBytes, 0, engineState, 4, 4 );
			Static.littleEndianToInt( keyBytes, keyBytes.length - 16, engineState, 8, 4 );
		}

		// IV
		Static.littleEndianToInt( ivBytes, 0, engineState, 14, 2 );
	}
