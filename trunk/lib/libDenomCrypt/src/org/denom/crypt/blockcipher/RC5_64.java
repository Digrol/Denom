 ...
 * CryptoBytes, Spring of 1995. <em>http://www.rsasecurity.com/rsalabs/cryptobytes</em>.
 * <p>
 * This implementation is set to work with a 64 bit word size.
 * <p>
 * Implementation courtesy of Tito Pena.
 */
public class RC5_64 implements BlockCipher
{
	...
	/*
	 * our "magic constants" for wordSize 62 Pw = Odd((e-2) * 2^wordsize) Qw = Odd((o-2) *
	 * 2^wordsize) where e is the base of natural logarithms (2.718281828...) and o is the golden
	 * ratio (1.61803398...)
	 */
	...
	/**
	 * Perform a left "spin" of the word. The rotation of the given word <em>x</em> is rotated left
